    ...
    <tr>
        <td>
            <a class="group1" href="<?php echo base_url(); ?>media/visitingcards/Chrysanthemum.jpg" title="Chrysanthemum">
                <img src="<?php echo base_url(); ?>media/visitingcards/Chrysanthemum.jpg" width="125" height="125" />
            </a>
        </td>
        <td>
            <a class="group1" href="<?php echo base_url(); ?>media/visitingcards/Desert.jpg" title="Desert">
                <img src="<?php echo base_url(); ?>media/visitingcards/Desert.jpg" width="125" height="125" />
            </a>
        </td>
        <td>
            <a class="group1" href="<?php echo base_url(); ?>media/visitingcards/Hydrangeas.jpg" title="Hydrangeas">
                <img src="<?php echo base_url(); ?>media/visitingcards/Hydrangeas.jpg" width="125" height="125" />
            </a>
        </td>
    </tr>
    <tr>
        <td>
            <a class="group1" href="<?php echo base_url(); ?>media/visitingcards/Jellyfish.jpg" title="Jellyfish">
                <img src="<?php echo base_url(); ?>media/visitingcards/Jellyfish.jpg" width="125" height="125" />
            </a>
        </td>
        <td>
            <a class="group1" href="<?php echo base_url(); ?>media/visitingcards/Koala.jpg" title="Koala">
                <img src="<?php echo base_url(); ?>media/visitingcards/Koala.jpg" width="125" height="125" />
            </a>
        </td>
        <td>
            <a class="group1" href="<?php echo base_url(); ?>media/visitingcards/Lighthouse.jpg" title="Lighthouse">
                <img src="<?php echo base_url(); ?>media/visitingcards/Lighthouse.jpg" width="125" height="125" />
            </a>
        </td>
    </tr>
</table>
