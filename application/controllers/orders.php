...
class Orders extends CI_Controller {
	...
	public function order_submit() {
		...
		if ($result['status'] == true) {
			...
			redirect('orders/details/' . $result['order_id']);
	...
	public function load_order_table_data() {
		...
		// indexes
		$columns = array( array('db' => 'order_ref_no', 'dt' => 0), array('db' => 'order_date', 'dt' => 1, 'formatter' => function($d, $row) {
			return gmdate('d-M-Y H:i A', $d);
		}), array('db' => 'username', 'dt' => 2), array('db' => 'firstname', 'dt' => 3), array('db' => 'lastname', 'dt' => 4), array('db' => 'total', 'dt' => 5, 'formatter' => function($d, $row) {
			return number_format($d);
		}), array('db' => 'payment_status_text', 'dt' => 6), array('db' => 'order_id', 'dt' => 7), );
	...
	public function load_my_order_table_data() {
		...
		$columns = array( array('db' => 'order_ref_no', 'dt' => 0), array('db' => 'order_date', 'dt' => 1, 'formatter' => function($d, $row) {
			return gmdate('d-M-Y H:i A', $d);
		}), array('db' => 'total', 'dt' => 2, 'formatter' => function($d, $row) {
			return number_format($d);
		}), array('db' => 'payment_status_text', 'dt' => 3), array('db' => 'order_id', 'dt' => 4), );
