...
--
-- Host: localhost
-- Generation Time: Aug 13, 2014 at 12:03 PM
...
INSERT INTO `pamphlets` (`card_id`, `parent_type_id`, `card_type`, `card_type_display`, `no_of_column`, `quantity`, `price`) VALUES
('PC_010102', 'PPT_000001', 'WF_70', 'W/F (70)', 1, 1000, '9.20'),
('PC_010110', 'PPT_000001', 'WF_70', 'W/F (70)', 2, 1000, '15.95'),
('PC_010118', 'PPT_000001', 'WF_70', 'W/F (70)', 3, 1000, '22.70'),
('PC_010126', 'PPT_000001', 'WF_70', 'W/F (70)', 4, 1000, '29.45'),
('PP_010101', 'PPT_000001', 'WF_70', 'W/F (70)', 1, 500, '16.65'),
('PP_010103', 'PPT_000001', 'WF_70', 'W/F (70)', 1, 1500, '6.70'),
('PP_010104', 'PPT_000001', 'WF_70', 'W/F (70)', 1, 2000, '5.40'),
('PP_010105', 'PPT_000001', 'WF_70', 'W/F (70)', 1, 2500, '4.95'),
('PP_010106', 'PPT_000001', 'WF_70', 'W/F (70)', 1, 3000, '4.80'),
('PP_010107', 'PPT_000001', 'WF_70', 'W/F (70)', 1, 5000, '3.90'),
('PP_010108', 'PPT_000001', 'WF_70', 'W/F (70)', 1, 10000, '3.50'),
('PP_010109', 'PPT_000001', 'WF_70', 'W/F (70)', 2, 500, '30.15'),
('PP_010111', 'PPT_000001', 'WF_70', 'W/F (70)', 2, 1500, '11.20'),
('PP_010112', 'PPT_000001', 'WF_70', 'W/F (70)', 2, 2000, '8.70'),
('PP_010113', 'PPT_000001', 'WF_70', 'W/F (70)', 2, 2500, '7.85'),
('PP_010114', 'PPT_000001', 'WF_70', 'W/F (70)', 2, 3000, '7.60'),
('PP_010115', 'PPT_000001', 'WF_70', 'W/F (70)', 2, 5000, '5.90'),
('PP_010116', 'PPT_000001', 'WF_70', 'W/F (70)', 2, 10000, '5.20'),
('PP_010117', 'PPT_000001', 'WF_70', 'W/F (70)', 3, 500, '43.65'),
('PP_010119', 'PPT_000001', 'WF_70', 'W/F (70)', 3, 1500, '15.70'),
('PP_010120', 'PPT_000001', 'WF_70', 'W/F (70)', 3, 2000, '12.00'),
('PP_010121', 'PPT_000001', 'WF_70', 'W/F (70)', 3, 2500, '10.75'),
('PP_010122', 'PPT_000001', 'WF_70', 'W/F (70)', 3, 3000, '10.40'),
('PP_010123', 'PPT_000001', 'WF_70', 'W/F (70)', 3, 5000, '7.90'),
('PP_010124', 'PPT_000001', 'WF_70', 'W/F (70)', 3, 10000, '6.90'),
('PP_010125', 'PPT_000001', 'WF_70', 'W/F (70)', 4, 500, '57.15'),
('PP_010127', 'PPT_000001', 'WF_70', 'W/F (70)', 4, 1500, '20.20'),
('PP_010128', 'PPT_000001', 'WF_70', 'W/F (70)', 4, 2000, '15.30'),
('PP_010129', 'PPT_000001', 'WF_70', 'W/F (70)', 4, 2500, '13.65'),
('PP_010130', 'PPT_000001', 'WF_70', 'W/F (70)', 4, 3000, '13.20'),
('PP_010131', 'PPT_000001', 'WF_70', 'W/F (70)', 4, 5000, '9.90'),
('PP_010132', 'PPT_000001', 'WF_70', 'W/F (70)', 4, 10000, '8.60');

-- --------------------------------------------------------

--
-- Table structure for table `pamphlet_film`
--

CREATE TABLE IF NOT EXISTS `pamphlet_film` (
  `id` int(11) NOT NULL,
  `type_id` varchar(30) NOT NULL,
  `no_of_column` int(11) NOT NULL,
  `price` decimal(10,2) NOT NULL,
...
--
-- Dumping data for table `pamphlet_film`
--

INSERT INTO `pamphlet_film` (`id`, `type_id`, `no_of_column`, `price`) VALUES
(1, 'PPT_000001', 1, '2000.00'),
(2, 'PPT_000001', 2, '4000.00'),
(3, 'PPT_000001', 3, '6000.00'),
(4, 'PPT_000001', 4, '8000.00');

-- --------------------------------------------------------

--
-- Table structure for table `pamphlet_lamanation`
--

CREATE TABLE IF NOT EXISTS `pamphlet_lamanation` (
  `id` int(11) NOT NULL,
  `type_id` varchar(30) NOT NULL,
  `lamanation` varchar(255) NOT NULL,
  `price` decimal(10,2) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `pamphlet_lamanation`
--

INSERT INTO `pamphlet_lamanation` (`id`, `type_id`, `lamanation`, `price`) VALUES
(1, 'PPT_000001', '2 sides', '7.00');

-- --------------------------------------------------------

--
-- Table structure for table `pamphlet_types`
--

CREATE TABLE IF NOT EXISTS `pamphlet_types` (
  `type_id` varchar(30) NOT NULL,
  `card_type_display` varchar(255) NOT NULL,
...
--
-- Dumping data for table `pamphlet_types`
--

INSERT INTO `pamphlet_types` (`type_id`, `card_type_display`, `quality`, `size`) VALUES
('PPT_000001', '1/4 x Legal', 'double side printing', '1/4 x Legal');
